...
api.add_resource(FumblesRoute, f'{API_BASE}/fumbles')
...
api.add_resource(PassesDefendedRoute, f'{API_BASE}/passes_defended')
api.add_resource(
...
api.add_resource(TimeOfPossessionRoute, f'{API_BASE}/time_of_possession')
